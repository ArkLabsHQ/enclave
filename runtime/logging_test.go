...
func TestLogHandlers(t *testing.T) {
	t.Run("post ships otlp", func(t *testing.T) {
		...
		require.Equal(t, "/prod/app/enclave/logs/app", aws.ToString(put.LogGroupName))
...
func TestSlogHandler(t *testing.T) {
	t.Run("ships the enclave own entry", func(t *testing.T) {
		...
		put := requireCloudWatchPutTo(t, cw, "/prod/app/enclave/logs/supervisor")
	...
	t.Run("keeps the supervisor out of the app group", func(t *testing.T) {
		...
		requireCloudWatchPutTo(t, cw, "/prod/app/enclave/logs/supervisor")
		cw.mu.Lock()
		defer cw.mu.Unlock()
